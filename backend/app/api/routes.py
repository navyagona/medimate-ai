...
async def transcribe(audio: UploadFile = File(...)):
    ...
    try:
        ...
        print(f"Error during audio upload transcription: {e}")
...
async def generate_soap(payload: dict):
    ...
    try:
        ...
        print(f"Error during SOAP generation: {e}")
...
async def run_evaluation_endpoint():
    ...
    try:
        # Import run_evaluation inside endpoint to avoid circular dependencies
